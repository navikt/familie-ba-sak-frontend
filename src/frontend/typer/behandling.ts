...
export enum BehandlingSteg {
    ...
    FILTRERING_AUTOMATISK_BEHANDLING = 'FILTRERING_AUTOMATISK_BEHANDLING',
...
export const hentStegNummer = (steg: BehandlingSteg): number => {
    switch (steg) {
        ...
        case BehandlingSteg.REGISTRERE_PERSONGRUNNLAG:
            return 1;
        case BehandlingSteg.FILTRERING_AUTOMATISK_BEHANDLING:
            return 2;
...
export enum BehandlingResultat {
    ...
    HENLAGT_AUTOMATISK_SØKNAD = 'HENLAGT_AUTOMATISK_SØKNAD',
...
export const erBehandlingHenlagt = (behandlingsresultat?: BehandlingResultat) => {
    return (
        ...
        behandlingsresultat === BehandlingResultat.HENLAGT_AUTOMATISK_SØKNAD ||
...
> = {
    ...
    HENLAGT_AUTOMATISK_SØKNAD: 'Henlagt automatisk søknad',
