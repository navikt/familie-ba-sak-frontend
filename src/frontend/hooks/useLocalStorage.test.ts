// Kopiert fra https://github.com/juliencrn/usehooks-ts/blob/master/packages/usehooks-ts/src/useLocalStorage/useLocalStorage.test.ts

import { act, renderHook } from '@testing-library/react';

import { useLocalStorage } from './useLocalStorage';

export const mockStorage = (name: 'localStorage'): void => {
...
describe('useLocalStorage()', () => {
    ...
    test('Remove the state removes localStorage key', () => {
        const { result } = renderHook(() => useLocalStorage('key', 'value'));
