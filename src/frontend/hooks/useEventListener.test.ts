// Kopiert fra https://github.com/juliencrn/usehooks-ts/blob/master/packages/usehooks-ts/src/useEventListener/useEventListener.test.ts
...
describe('useEventListener()', () => {
    ...
    test('should call the event listener handler when the event is triggered', () => {
    ...
    test('should have the correct event type', () => {
