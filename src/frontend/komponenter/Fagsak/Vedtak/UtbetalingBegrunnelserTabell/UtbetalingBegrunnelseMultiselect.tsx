...
} from '../../../../context/UtbetalingBegrunnelseContext';
...
const UtbetalingBegrunnelseMultiselect: React.FC<IUtbetalingsBegrunnelseMultiselect> = ({
    ...
    const { utbetalingBegrunnelseSubmit, vilkårBegrunnelser } = useUtbetalingBegrunnelser();
    const { hentUtgjørendeVilkår, onChangeBegrunnelse } = useUtbetalingBegrunnelse(
        personResultater,
        periode
    );

    const submitForPeriode: IUtbetalingBegrunnelseSubmit | undefined =
        lagPeriodeId(periode) === utbetalingBegrunnelseSubmit.periodeId
    ...
    return (
        <>
            <SkjultLegend>Begrunnelser</SkjultLegend>
            <FamilieReactSelect
                ...
                onChange={(_, action: ActionMeta<ISelectOption>) => {
                    onChangeBegrunnelse(action, utbetalingBegrunnelseForPeriode);
                }}
                formatOptionLabel={(
