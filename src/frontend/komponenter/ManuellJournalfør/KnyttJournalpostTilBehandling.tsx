...
export const KnyttJournalpostTilBehandling: React.FC = () => {
    ...
    const sorterteJournalpostbehandlinger = hentSorterteJournalpostbehandlinger();

    return (
        <KnyttDiv>
            {sorterteJournalpostbehandlinger.length > 0 && (
                <>
                    ...
                    <Table>
                        ...
                        <Table.Body>
                            {sorterteJournalpostbehandlinger.map(behandling => {
                                return (
                                    <Table.Row
                                        key={behandling.id}
