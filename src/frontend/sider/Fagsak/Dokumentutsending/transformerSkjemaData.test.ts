...
describe('transformerSkjemaData', () => {
    ...
    describe('hentDeltBostedMultiselectVerdierForBarn', () => {
        test('formaterer en tekstlinje per avtaledato for barnet', () => {
            const verdier = hentDeltBostedMultiselectVerdierForBarn({
                ...merketBarn,
                avtalerOmDeltBosted: [{ dato: '2020-06-01' }, { dato: '2021-01-15' }],
            });
        ...
        test('returnerer tom liste når barnet ikke har noen avtaler', () => {
            const verdier = hentDeltBostedMultiselectVerdierForBarn({ ...merketBarn, avtalerOmDeltBosted: [] });
