...
import { vilkårBegrunnelseFeilmeldingId, vilkårResultatFeilmeldingId } from './VilkårTabell';
...
const VilkårTabellRadEndre = ({
    ...
    const { vilkårsvurdering, putVilkår, vilkårSubmit, settVilkårSubmit } = useVilkårsvurderingContext();
