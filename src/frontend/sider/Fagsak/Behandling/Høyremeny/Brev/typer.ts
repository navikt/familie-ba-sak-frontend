...
export enum Brevmal {
    ...
    VARSEL_OM_REVURDERING_INSTITUSJON = 'VARSEL_OM_REVURDERING_INSTITUSJON',
    ...
    HENLEGGE_TRUKKET_SØKNAD_INSTITUSJON = 'HENLEGGE_TRUKKET_SØKNAD_INSTITUSJON',
    SVARTIDSBREV = 'SVARTIDSBREV',
    SVARTIDSBREV_INSTITUSJON = 'SVARTIDSBREV_INSTITUSJON',
    VARSEL_OM_ÅRLIG_REVURDERING_EØS = 'VARSEL_OM_ÅRLIG_REVURDERING_EØS',
...
export enum Informasjonsbrev {
    ...
    INFORMASJONSBREV_FØDSEL_VERGEMÅL = 'INFORMASJONSBREV_FØDSEL_VERGEMÅL',
    ...
    INFORMASJONSBREV_TIL_FORELDER_MED_SELVSTENDIG_RETT_VI_HAR_FÅTT_F016_KAN_SØKE_OM_BARNETRYGD = 'INFORMASJONSBREV_TIL_FORELDER_MED_SELVSTENDIG_RETT_VI_HAR_FÅTT_F016_KAN_SØKE_OM_BARNETRYGD',
    ...
    INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE = 'INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE',
    INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE_INSTITUSJON = 'INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE_INSTITUSJON',
}
...
export const brevmaler: Record<Brevmal, string> = {
    ...
    VARSEL_OM_REVURDERING_INSTITUSJON: 'Varsel om revurdering institusjon',
    HENLEGGE_TRUKKET_SØKNAD: 'Henlegg søknad',
    HENLEGGE_TRUKKET_SØKNAD_INSTITUSJON: 'Henlegg søknad institusjon',
    SVARTIDSBREV: 'Svartidsbrev',
