...
export declare enum Behandlingsresultatstype {
...
export declare enum Behandlingsstatus {
    AVSLUTTET = "AVSLUTTET",
...
export declare enum Tilbakekrevingsbehandlingstype {
    TILBAKEKREVING = "TILBAKEKREVING",
    REVURDERING_TILBAKEKREVING = "REVURDERING_TILBAKEKREVING"
}
export declare enum TilbakekrevingsbehandlingÅrsak {
...
export declare enum TilbakekrevingsbehandlingResultat {
    IKKE_FASTSATT = "IKKE_FASTSATT",
    INGEN_TILBAKEBETALING = "INGEN_TILBAKEBETALING",
    DELVIS_TILBAKEBETALING = "DELVIS_TILBAKEBETALING",
    FULL_TILBAKEBETALING = "FULL_TILBAKEBETALING",
